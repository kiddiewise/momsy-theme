...
{
    $icons = [
        'article'    => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M7 4.75h8.5l3.75 3.75V19a1.5 1.5 0 0 1-1.5 1.5H7A2.25 2.25 0 0 1 4.75 18.25V7A2.25 2.25 0 0 1 7 4.75Z" /><path d="M15.5 4.75V9h4.25" /><path d="M8.5 12.25h7" /><path d="M8.5 15.5h7" /></svg>',
        ...
        'grid'       => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="4.25" y="4.25" width="6.5" height="6.5" rx="1.3" /><rect x="13.25" y="4.25" width="6.5" height="6.5" rx="1.3" /><rect x="4.25" y="13.25" width="6.5" height="6.5" rx="1.3" /><rect x="13.25" y="13.25" width="6.5" height="6.5" rx="1.3" /></svg>',
        ...
        'home'       => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4.75 10.5 12 4.75l7.25 5.75V19a1.5 1.5 0 0 1-1.5 1.5h-3.5v-6h-4.5v6h-3.5A1.5 1.5 0 0 1 4.75 19Z" /></svg>',
        'briefcase'  => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3.75" y="6.75" width="16.5" height="12.5" rx="2.5" /><path d="M9 6.75V5.5A1.75 1.75 0 0 1 10.75 3.75h2.5A1.75 1.75 0 0 1 15 5.5v1.25" /><path d="M3.75 11.5h16.5" /></svg>',
        ...
        'verified'   => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="12" cy="12" r="8.5" fill="currentColor" /><path d="m8.5 12 2.35 2.35 4.65-4.9" stroke="#ffffff" stroke-width="2.05" stroke-linecap="round" stroke-linejoin="round" /></svg>',
    ];
